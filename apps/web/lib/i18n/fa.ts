...
export const fa = {
  ...
  editor: {
    ...
    expenseAmount: "مبلغ",
    saving: "در حال ذخیره…",
    draftFound: "نسخه ذخیره‌نشده‌ای از این سند روی همین دستگاه پیدا شد",
    draftRestore: "بازیابی",
    draftDiscard: "دور انداختن",
    draftRestored: "نسخه ذخیره‌نشده بازیابی شد — برای ثبت، ذخیره کنید",
  ...
  common: {
    ...
    error: "خطایی رخ داد",
    saved: "ذخیره شد",
    saveFailed: "ذخیره نشد — اتصال اینترنت را بررسی کنید و دوباره تلاش کنید",
    deleted: "حذف شد",
